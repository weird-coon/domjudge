...
echo "<div style='margin-top: 30px;' class=\"row\" id=\"submitlist\">\n";
echo "<div class='col s8 offset-s2 white z-depth-1 pd-s8'>";
echo "<h3 class=\"teamoverview team-title flow-text\">Submissions</h3>\n\n";
...
if ( $fdata['cstarted'] ) {
	if ( $submitted ) {
		...
		echo addForm('upload.php','post',null,'multipart/form-data', null,
		    ...
		    "<p id=\"submitform\">\n\n";
		    echo "<div class=\"file-field input-field\"><div class=\"btn\"><span>FILE</span>";
		    /*INPUT*/
			...
			echo " />\n";
			/*INPUT*/
		    echo "</div><div class=\"file-path-wrapper\"><input class=\"file-path validate\" type=\"text\" placeholder=\"Choose file..\"/></div></div>";
...
echo "<div class='row' id=\"clarlist\">\n";
echo "<div class='col s8 offset-s2 white z-depth-1 pd-s8'>";
...
echo "<h3 class=\"teamoverview flow-text team-title\">Clarifications</h3>\n";
...
echo "<h3 class=\"teamoverview flow-text team-title\">Clarification Requests</h3>\n";

...
echo "<div class='contaier' style='margin-bottom: 100px'>";
echo "<div class='row'>";
...
if ( !empty($_GET['cmd']) ):
	...
	echo "<h2 class='flow-text'>$title</h2>\n\n";

	echo addForm('edit.php');

	echo "<table class='z-depth-1 white'>\n";
...
?>
<tr><td class="tb-add"><label for="data_0__shortname_">Shortname:</label></td>
<td class="pd-add" style="width: 70%"><?php echo addInput('data[0][shortname]', @$row['shortname'], 40, 30, 'required')?></td></tr>

<tr><td class="tb-add"><label for="data_0__name_">Name:</label></td>
<td class="pd-add" style="width: 70%"><?php echo addInput('data[0][name]', @$row['name'], 40, 255, 'required')?></td></tr>

<tr><td class="tb-add"><label for="data_0__country_">Country:</label></td>
<td class="pd-add" style="width: 70%"><?php echo addInput('data[0][country]', @$row['country'], 4, 3, 'pattern="[A-Z]{3}" title="three uppercase letters (ISO-3166-1 alpha-3)"')?>
<a target="_blank"
...
<td class="pd-add" style="width: 70%"><?php echo addTextArea('data[0][comments]', @$row['comments'])?></td></tr>
...
if ( $teams->count() == 0 ) {
	...
	echo "<table class=\"list z-depth-1 white\">\n<thead>\n" .

...
if ($olddata !== NULL) {
	...
	$html .= "<h2 class='flow-text title-scoreboard' id=\"diff\">Diff to submission " .
...
if ( !empty($origsources) ) {
	...
	$html .= "<h2 class='flow-text title-scoreboard' id=\"origdiff\">Diff to original submission " .
	         "<a href=\"submission.php?id=$origid\">s$origid</a></h2>\n\n";

	$html .= multifilediff($sources, $origsources, $origdata);
}

echo "<h2 class='flow-text title-scoreboard'>Source code for submission <a href=\"submission.php?id=" .

...
echo "<h1 class=\"title-scoreboard flow-text\">Contests</h1>\n\n";
...
if( count($res) == 0 ) {
	...
	echo "<h3 style=\"font-size: 30px;margin-top: 20px;\" class=\"title-scoreboard flow-text\">All available contests</h3>\n\n";
	echo "<table class=\"white z-depth-1 striped list sortable\">\n<thead>\n" .

...
echo "<div class=\"btn\" style=\"margin-top:50px;margin-bottom:50px;\" ><a href=\"problem.php?id=" . urlencode($probid) . "\" style=\"color:white;\">back to problem p" .
	specialchars($probid) . "</a></div>\n\n";
...
if ( count($data)==0 ) {
	...
	?>
<table class="z-depth-1 white striped list sortable" class="list testcases">
<thead><tr>
...
?>
<h3 style="margin-top: 20px;" class="flow-text title-scoreboard">Create new testcase</h3>

<table class="white z-depth-1 list sortable">
<tr><td class="tb-add">Input testdata: </td><td><?php echo addFileField('add_input')  ?></td></tr>
<tr><td class="tb-add">Output testdata:</td><td><?php echo addFileField('add_output') ?></td></tr>
<tr><td class="tb-add">Sample testcase:</td><td><?php echo "<div style='width: 50%'>"; echo addSelect('add_sample', array("no","yes"), 0, true); echo '</div>';?></td></tr>
<tr><td class="tb-add">Description:    </td><td><?php echo "<div style='width: 50%'>"; echo addInput('add_desc','',30); echo '</div>'; ?></td></tr>
<tr><td class="tb-add">Image:          </td><td><?php echo addFileField('add_image') ?></td></tr>
</table>
<?php

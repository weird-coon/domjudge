...
echo "<h1 class=\"title-scoreboard flow-text\">Judgehosts</h1>\n\n";
...
<?php
	echo "\n<table class='white z-depth-1' id=\"judgehosts\">\n" .
		"<tr><th class='tb-add'>Hostname</th><th class='tb-add'>Active</th><th class='tb-add'>Restrictions</th></tr>\n";
	if ( $cmd == 'add' ) {
		...
		while ( $row = $res->next() ) {
			echo "<tr><td class='tb-add'>" .
				...
				"</td><td class='tb-add' style='padding-right: 30px;'>" .
				"</div><div class='input-field' style='width:50%;'>".
...
if( $res->count() == 0 ) {
	...
	echo "<table class=\"striped z-depth-1 list sortable\">\n<thead>\n" .

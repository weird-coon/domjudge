...
<?php
	...
	if ( IS_JURY ) { // list all possible recipients in the "sendto" box
		echo "<tr><td class='tb-add'><b><label for=\"sendto\">Send to</label>:</b></td><td>\n";
		...
		echo '<div style="width:50%">'.addSelect('sendto', $options, 'domjudge-must-select', true).'</div>';
		echo "</td></tr>\n";
	} else {
		echo "<tr><td class='tb-add'><b>To:</b></td><td>Jury</td></tr>\n";
	}
	...
	echo "<tr><td class='tb-add'><b>Subject:</b></td><td>\n" ."<div style='width:50%'>".
	...
	?>
<tr>
<td class="tb-add"><b><label for="bodytext">Text</label>:</b></td>
<td class="pd-add"><?php
$body = "";
if ( $respid ) {

...
function show_failed_login($msg)
{
	...
	echo '<div class="container" style="margin-bottom: 200px;">';
	echo '<div class="row" style="margin-top:50px;">';
	echo "<h1 class='title-scoreboard flow-text'>Not Authenticated</h1>\n\n
	<p>$msg</p>\n\n";
	echo '</div>';
	echo '</div>';
...
function show_loginpage()
{
	...
	case 'LDAP':
		...
		?>
<body style="background: #00bcd4 !important;height: 100%;">		
	      ...
	      <form class="login-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
	         ...
	         <div class="row">
	            <div class="input-field col s12 center">
	               <img src="../images/final-logo.png" alt="" class="circle responsive-img valign profile-image-login">
	               <p class="center login-form-text">Not Authenticated<br>please login</p>
	            </div>
	         </div>
	         <div class="row margin">
	            <div class="input-field col s12">
	               <!-- <i class="mdi-social-person-outline prefix"></i> -->
	               <i class="small material-icons prefix ilogin">perm_identity</i>
	               <input required="required" type="text" id="login" name="login" value="" size="15" maxlength="15" accesskey="l" autofocus>
	         ...
	         <div class="row margin">
	            <div class="input-field col s12">
	               ...
	               <i class="small material-icons prefix ilogin">lock</i>
	               <input required="required" type="password" id="passwd" name="passwd" value="" size="15" maxlength="255" accesskey="p">
	         ...
	         <div class="row">
	            <div class="input-field col s12">
	            	<input id="sm-login" style="background: #ff4081;" type="submit" class="btn waves-effect waves-light col s12 z-depth-3" value="Login" />
...
function do_login()
{
	...
	case 'LDAP':
		...
		if ( !$userdata ||
			...
			sleep(1);
			show_failed_login("Invalid username or password supplied.<br />" .
			                  "Please try again or contact a staff member.<br />Click <a href='../'>here</a> to reload page ");
		}
...
function do_login_native($user, $pass)
{
	...
	if ( !$userdata ) {
		sleep(1);
		show_failed_login("Invalid username or password supplied.<br />" .
		                  "Please try again or contact a staff member..<br />Click <a href='../public/login.php'>here</a> to reload this page ");
	}
	               ...
	               <div class="row">
	                  <div id="site-layout-example-top" class="col s12">
	                     <p class="flat-text-logo center white-text caption-uppercase">
	                     	Successfully logged out as user <?php echo specialchars($username); ?>
	                     </p>
	                  </div>
	                  <div id="site-layout-example-right" class="col s12 m12 l12">
	                     <div style="margin-top: 40px;" class="row center">
	                        <p style="font-size: 16px;" class="center flow-text col s12">Click homepage below to return to the main site</p>
	                        <p class="center s12">

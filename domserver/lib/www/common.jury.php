...
{
	return "<a class=\"white-text waves-effect waves-light btn\" href=\"" . specialchars($table) . ".php?cmd=add\">" .
		"<i class=\"white-text material-icons left\">note_add</i>add</a>";
...
{
	return "<a class=\"waves-effect waves-light btn\" href=\"" . specialchars($table) . ".php?cmd=edit" .
...
function delLinkMultiple($table, $fields, $values, $referrer = '')
{
	...
	return "<a class=\"waves-effect waves-light btn\" href=\"delete.php?table=" . urlencode($table) . $arguments .
	       "&amp;referrer=" . urlencode($referrer)
	       ."\"><i class=\"large material-icons\">not_interested</i></a>";
}
